...
Library use:
    from corrfilter.screening import screen_candidate
...
from corrfilter.screening import generators as gen
from corrfilter.screening.generators import Source, marginal_params, wrong_probs
