...
from feasibility_screen import (FIXED, _clean_metrics, _instances,  # noqa: E402
                                _mk_source, screen_candidate)
from corrfilter.judges.prompts_pointwise import (  # noqa: E402
    CodePointwiseDirectTemplate, CodePointwiseTraceTemplate)
...
def test_headroom_and_gate_reject_zero_headroom(tmp_path):
    ...
    import feasibility_screen as fs
...
def test_rejection_reason_labels():
    from feasibility_screen import HEADROOM_GATE_PTS, NONZERO_RATE_GATE
