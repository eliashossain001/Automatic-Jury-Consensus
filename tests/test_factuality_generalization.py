...
from corrfilter.data.generic_task import (  # noqa: E402
    LABEL_MAPPING, FactualityItem, JudgeTaskBatch, _item_hash,
    stratified_sample)
from corrfilter.judges.prompts_pointwise import (  # noqa: E402
    PointwiseAnalysisTemplate, PointwiseDirectTemplate, _parse_verdict)
from corrfilter.routing import correlation_cluster  # noqa: E402
...
def test_no_position_features_for_pointwise():
    ...
    from run_learned_router import BASE_FEATS
...
def test_zero_shot_fixed_filter_source_only():
    ...
    from run_learned_router import best_fixed_on
    md = pd.DataFrame([
