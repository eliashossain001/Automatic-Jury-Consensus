"""Unit tests for the extended routing evaluation (scripts/routing).
...
from corrfilter.routing import FIXED, pooled_confusion, pooled_precision
from corrfilter.screening.generators import P_HI, P_LO, WRONG_MARGINAL, marginal_params, wrong_probs
...
def test_mixture_partition_counts():
    from corrfilter.screening.generators import majority_regime, mixtures
