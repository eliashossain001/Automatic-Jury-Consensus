"""Tests for corrfilter.routing: parity with the original regime routers."""
...
def test_parity_with_script18_agree_features():
    """The canonical module must reproduce the regime router's private implementation."""
    import importlib.util

    spec = importlib.util.spec_from_file_location(
        "regime_router",
        Path(__file__).resolve().parents[1] / "scripts" / "routing" / "regime_router.py")
