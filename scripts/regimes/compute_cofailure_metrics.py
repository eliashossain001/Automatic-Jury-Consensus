...
* per-judge × mechanism: conditional error rate (for the heatmap in script 08).
...
Usage:
    python scripts/regimes/compute_cofailure_metrics.py [--config configs/cfi.yaml]
"""
...
from corrfilter.cfi.corrfilter_score import RMode, corrfilter_score, resolve_R, retention_match_threshold
...
logger = logging.getLogger("scripts.regimes.compute_cofailure_metrics")
