...
judge (scripts/regimes/analyze_cofailure_experiment.py). Votes are cached per mechanism so reruns
...
Usage:
    ...
    python scripts/regimes/run_cofailure_votes_gpu.py --config configs/cfi_bias_prompts.yaml
    # smoke test:
    python scripts/regimes/run_cofailure_votes_gpu.py --max-items 24 --mechanism verbosity_bias \
...
logger = logging.getLogger("scripts.regimes.run_cofailure_votes_gpu")
