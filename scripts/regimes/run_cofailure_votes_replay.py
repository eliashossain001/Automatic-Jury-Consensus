...
Usage:
    python scripts/regimes/run_cofailure_votes_replay.py [--config configs/cfi.yaml] [--mode replay|real]
"""
...
logger = logging.getLogger("scripts.regimes.run_cofailure_votes_replay")
...
def main() -> None:
    ...
    if not manifest_path.exists():
        raise FileNotFoundError(
            f"CFI manifest not found at {manifest_path}; run scripts/regimes/build_cofailure_manifest.py first"
        )
