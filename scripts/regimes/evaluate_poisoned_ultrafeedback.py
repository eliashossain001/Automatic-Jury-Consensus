...
Usage:
    python scripts/regimes/evaluate_poisoned_ultrafeedback.py --project-root .
"""
...
def main() -> None:
    ...
    if coverage < 0.5:
        print("WARNING: <50% vote coverage; run scripts/regimes/run_ultrafeedback_judges.py to completion first.")
