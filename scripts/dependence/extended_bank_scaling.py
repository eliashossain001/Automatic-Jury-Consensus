...
Given the extended-bank votes (produced by scripts/calibration/run_judge_bank.py on configs/judge_bank_extended.yaml),
...
Usage:
  python scripts/dependence/extended_bank_scaling.py --bank configs/judge_bank_extended.yaml \
...
from corrfilter.analysis.dependence import (
    contrast,
    dependence_metrics,
    item_ids_from_manifest,
    load_votes,
)
