...
Usage: python scripts/40_multiprovider_full_analysis.py [--dataset rewardbench pku]
...
_s34 = _load_script("gba", "34_gemini_bank_analysis.py")
_s39 = _load_script("orp", "39_openrouter_pilot_analysis.py")
