...
Mirror of scripts/frontier/run_gemini_judges.py for OpenRouter, writing to the fully
...
Usage:
  python scripts/frontier/run_openrouter_judges.py --dataset rewardbench --limit 20 \
...
from corrfilter.judges.openrouter_judge import KEY_ENV_VARS, OpenRouterJudge
...
_spec33 = importlib.util.spec_from_file_location("run_gemini", HERE / "run_gemini_judges.py")
