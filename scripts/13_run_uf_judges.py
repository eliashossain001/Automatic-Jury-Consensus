...
serves all corruption rates (corruption is applied at evaluation time, scripts/14).

Efficiency mirrors scripts/07: load each of the five base models once and sweep
...
Usage:
    ...
    python scripts/13_run_uf_judges.py --project-root .
    # smoke: python scripts/13_run_uf_judges.py --base-id phi-3.5-mini --max-items 24
"""
