...
Usage:
  python scripts/preference_training/run_forced_choice_banks.py                          # all models, all banks
  python scripts/preference_training/run_forced_choice_banks.py --base-id qwen-2.5-7b    # one model
  python scripts/preference_training/run_forced_choice_banks.py --max-items 40 --smoke   # quick check
