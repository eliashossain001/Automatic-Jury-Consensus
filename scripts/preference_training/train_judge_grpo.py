...
Usage (one model, one seed, pinned to one GPU):
    CUDA_VISIBLE_DEVICES=0 python scripts/preference_training/train_judge_grpo.py \
...
from corrfilter.judges.prompts import PairwisePrompt, _extract_first_letter  # noqa: E402
