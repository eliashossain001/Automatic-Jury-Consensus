...
scripts/preference_training/run_forced_choice_banks.py plus the published generated caches (read-only) for the protocol-validity check.
...
Usage: python scripts/preference_training/analyze_forced_choice_banks.py
"""
...
from compute_dependence import (cofailure, estimate_R, item_ids_from_manifest,  # noqa: E402
                                load_votes)
from corrfilter.cfi.consensus import ABSTAIN  # noqa: E402
from corrfilter.correlation.effective_size import (effective_eig_rank,  # noqa: E402
