...
Routers evaluated:
  hard_unsupervised   script 18's clean-referenced threshold rule (dataset-level)
  supervised_loo      script train_router_dev's leave-one-out logistic regression
  soft_v2             script 19's softmax router, dataset-level argmax
...
Usage: python scripts/routing_selector/evaluate_routing_accuracy.py
...
# Constants copied from scripts/routing_selector/run_regime_router.py (clean-bank-referenced).
...
def main() -> None:
    ...
    # sanity check vs the persisted confusion matrix of script 18
    ...
    with open(out_dir / "summary.md", "w") as f:
        ...
        f.write("\n\nHard-router confusion matrix reproduced from scripts/routing_selector/run_regime_router.py output: "
