...
Usage:
  python scripts/downstream/integrate_reward_model_weights.py --smoke
  python scripts/downstream/integrate_reward_model_weights.py --pretrain-only
  python scripts/downstream/integrate_reward_model_weights.py            # full run
  python scripts/downstream/integrate_reward_model_weights.py --regimes pos10 syn10 --no-secondary
"""
...
from corrfilter.cfi.consensus import (  # noqa: E402
    ABSTAIN, consensus_level, majority_consensus, supermajority_consensus, vote_fraction)
