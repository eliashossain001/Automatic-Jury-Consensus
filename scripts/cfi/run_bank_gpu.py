...
judge (scripts/cfi/analyze_gpu_bank.py). Votes are cached per mechanism so reruns
...
Usage:
    ...
    python scripts/cfi/run_bank_gpu.py --config configs/cfi_bias_prompts.yaml
    # smoke test:
    python scripts/cfi/run_bank_gpu.py --max-items 24 --mechanism verbosity_bias \
