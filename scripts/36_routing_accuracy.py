...
Usage: python scripts/36_routing_accuracy.py
...
# Constants copied from scripts/18_regime_router.py (clean-bank-referenced).
...
def main() -> None:
    ...
    with open(out_dir / "summary.md", "w") as f:
        ...
        f.write("\n\nHard-router confusion matrix reproduced from scripts/18 output: "
