...
Safety rails identical to scripts/33/38: dry-run by default (prints cost
...
Usage:
  python scripts/45_run_factuality_frontier.py --stage pilot            # dry-run
  python scripts/45_run_factuality_frontier.py --stage pilot --live --budget 0.50
  python scripts/45_run_factuality_frontier.py --stage main  --live --budget 9.00
"""
