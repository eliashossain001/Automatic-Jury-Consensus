...
Usage
-----
  python scripts/analysis/d5_tie_break_diagnostic.py
"""
...
from corrfilter.cfi.consensus import (ABSTAIN, consensus_level,  # noqa: E402
                                      majority_consensus, vote_fraction)
