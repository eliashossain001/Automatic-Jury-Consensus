...
Usage:
  python scripts/training/forced_choice_bank.py                          # all models, all banks
  python scripts/training/forced_choice_bank.py --base-id qwen-2.5-7b    # one model
  python scripts/training/forced_choice_bank.py --max-items 40 --smoke   # quick check
...
from corrfilter.judges.forced_choice import ForcedChoiceJudge
