...
Given a trained bank (its votes already produced by scripts/calibration/run_judge_bank.py) and the matched base
...
Usage:
  python scripts/training/eval_judge_bank.py --trained-bank configs/dpo_judge.yaml --label dpo \
