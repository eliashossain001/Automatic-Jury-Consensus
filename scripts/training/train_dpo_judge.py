...
Preference-optimization alternative to GRPO (scripts/training/train_grpo_judge.py). For each calibration item we
...
Usage (Newton):
  python scripts/training/train_dpo_judge.py --model Qwen/Qwen2.5-7B-Instruct \
