...
Safety rails identical to scripts/frontier/run_gemini_judges.py/38: dry-run by default (prints cost
...
Usage:
  python scripts/crosstask/run_factuality_frontier.py --stage pilot            # dry-run
  python scripts/crosstask/run_factuality_frontier.py --stage pilot --live --budget 0.50
  python scripts/crosstask/run_factuality_frontier.py --stage main  --live --budget 9.00
"""
...
from corrfilter.judges.gemini_judge import GeminiJudge
from corrfilter.judges.openrouter_judge import OpenRouterJudge
from corrfilter.judges.prompts_pointwise import register_pointwise_templates
