...
Usage:
    python scripts/attacks/eval_poisoned_uf.py --project-root .
"""
...
def main() -> None:
    ...
    if coverage < 0.5:
        print("WARNING: <50% vote coverage; run scripts/attacks/run_poisoned_uf_judges.py to completion first.")
