...
Usage:
  python scripts/22_mainstream_alignment_integration.py --smoke
  python scripts/22_mainstream_alignment_integration.py --pretrain-only
  python scripts/22_mainstream_alignment_integration.py            # full run
  python scripts/22_mainstream_alignment_integration.py --regimes pos10 syn10 --no-secondary
"""
